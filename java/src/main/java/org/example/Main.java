...
public class Main {
    ...
    private static final String KAFKA_SINGLE_IP = "localhost:9092";
    private static final String RECEIVE_TOPIC_NAME = "boaz";
    private static final String SEND_TOPIC_NAME = "boaz";
